            ...
            child: TextButton(
                onPressed: () async {
                  ...
                  var payload = <String, String>{
                    ...
                    'email': email,
                    'advanceDeposit': '${textController.text}',
                    'bookingStatus': '0'
                  };
                  Result<OrderRoomBooked> result = await postOderRoom(
                    payload,
                    // timeBookingStart: controller.dateStart.toString(),
                    // timeBookingEnd: controller.dateEnd.toString(),
                    // totalRoomRate: priceRoom * controller.quantilyRoom.value,
                    // advanceDeposit: textController.text,
                  );
                   await Get.to(ListRoomView(type: 'book multiple rooms',));
                  // if (result.isValue) {
                  // } else {
                  // }
